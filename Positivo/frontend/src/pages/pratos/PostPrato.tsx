...
interface PostPratoProps {
  onCreated?: () => void;  // callback opcional para avisar que criou prato
}

export default function PostPrato({ onCreated }: PostPratoProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    axios
      ...
      .then(() => {
        ...
        setRestauranteId('');
        if (onCreated) {
          onCreated();  // chama o callback avisando que criou prato
        }
      })
      .catch((err) => {
